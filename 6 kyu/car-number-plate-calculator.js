...
function findTheNumberPlate(customerID){
    let alphabet = ["a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"];
      ...
      let letterP = Math.floor(customerID/999)
      let num = customerID- 999*letterP +1 
      ...
      let m = `${alphabet[letterP % 26]}${alphabet[Math.floor(letterP / 26) % 26]}${alphabet[Math.floor(letterP/(26*26))%26]}`
